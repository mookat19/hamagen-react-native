...
const LocationIOS = ({
  navigation,
  strings: {
    locationIOS: { title, subTitle1, subTitle2, goToSettings, set },
  },
  isRTL,
}: Props) => {
  ...
  return (
    <GeneralContainer style={styles.container}>
      ...
      <View style={{ alignItems: 'center' }}>
        ...
        <Icon
          source={require('../../assets/onboarding/locationTutorial.png')}
        ...
        <TouchableOpacity onPress={() => Linking.openURL('app-settings:')}>
          <View
            ...
            <Icon
              source={require('../../assets/onboarding/settings.png')}
              width={17}
              customStyles={{ marginHorizontal: 7 }}
            />
            <Text
